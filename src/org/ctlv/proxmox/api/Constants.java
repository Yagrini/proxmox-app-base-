...
public class Constants {
	...
	public static String USER_NAME = "lagrini"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "XXXXXXX"; // votre mot de passe . XXX
	...
	public static String CT_BASE_NAME = "ct-tpgei-virt-B5-ct";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
